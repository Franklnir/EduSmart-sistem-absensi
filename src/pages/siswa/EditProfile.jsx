// src/pages/siswa/SEditProfile.jsx
...
async function compressImageTo1MB(file, maxBytes = 1024 * 1024) {
  ...
  // batasi dimensi supaya tidak terlalu besar
  const maxDim = 1024
...
/* ==================== COMPONENT ==================== */
export default function SEditProfile() {
  ...
  async function handleFileChange(e) {
    ...
    try {
      ...
      const url = await uploadFile(
        SUPABASE_BUCKET,
        `${user.uid}.jpg`, // nama file tetap → otomatis timpa di bucket
        compressed,
      )

      setPhotoURL(url)

      // update hanya field foto di RTDB (supaya tidak mengganggu field lain yg belum disimpan)
  ...
  return (
    // ➜ Hapus max-w agar tampilan bisa lebar, cukup padding saja
    <div className="w-full px-6 py-6">
      <div className="card w-full">
        <div className="flex justify-between items-center mb-4">
          <h1 className="font-bold text-xl">Edit Profil</h1>
        </div>
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Kelas tidak bisa diubah sendiri. Hubungi admin jika ada
                kesalahan.
              </p>
            </div>
